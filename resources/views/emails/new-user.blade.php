        ...
        <tr>
          <td align="center" valign="top" id="bodyCell">
            ...
            <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
              ...
              <tr>
                <td align="center" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#10657e">
                    <tr>
                      <td align="center" valign="top">
                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tr>
                                  <td align="center" valign="top" class="textContent">
                                    <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">QC WIS</h1>
                                    <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#C9BC20;line-height:135%;">{{ $emailAction }}</h2>
                                  </td>
                                </tr>
                              </table>
                            </td>
                                        ...
                                        <td valign="top" class="textContent">
                                          <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;"></h3>
                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                ...
                                                @if($password)
                                                  <p>Password : {{ $password }}<br><small>Use this computer generated password to login and change it later.</small></p>
                                                @endif


                                                @if ($access)
                                                <p>You can access the following page/s:</p>
                                                <ol>
                                                    @php
                                                ...
                                                @if ($permissions)
                                                <p>You have the following permission/s to:</p>
                                                <ol>
                                                   
                                                    @php
                                                    $permissions_ = explode(',', $permissions);
                                                    foreach ($permissions_ as $keyPermission => $valuePermission) {
                                                        echo '<li>' .$valuePermission . '</li>';
                                                    }
                                                    @endphp
                                                </ol>
                                                @endif
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #2E7D32;">
                                      <tr>
                                        <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                          <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="http://127.0.0.1:8000/" target="_blank">Click me to login</a>
                                        </td>
                                      </tr>
                                    </table>
